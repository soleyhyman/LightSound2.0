...
class MainFrame(wx.Frame):
    ...
    def About(self):
        ...
        aboutInfo.SetCopyright("(C) Sóley Hyman 2024")
    ...
    def startUpWindow(self):
        startupDlg = wx.RichMessageDialog(self, "Welcome to the LightSound Computer Interface!\n\n"
                                             ...
                                             + " \n"
                                             + "To go to the Quick Start Guide, go to Menu and Help or Help (accessible).\n"
                                             + " \n"
                                             + "If you are using a screenreader, you can navigate using tab, arrow,\n"
                                             + "enter, and spacebar keys on your keyboard. To get to the Menu on the\n"
                                             + "main window and Plotting Options window, use Alt or Option keys or\n"
                                             + "Ctrl+M to enter it and Esc to escape it. To close any window, press\n"
                                             + "Ctrl+W or Ctrl+Q.", 
    ...
    def OnLiveplotButton(self,event):
        ...
        dlg = wx.MessageDialog(None, "Press Start/Stop toggle button below to begin liveplotting."
                                ...
                                +" automatically save plot. You can exit this window by pressing Ctrl+W.",
...
class plotDataFrame(wx.Frame):
    ...
    def MenuBar(self):    
        ...
        fileMenu = wx.Menu()            
        exitItem = wx.MenuItem(fileMenu, wx.ID_EXIT, '&Exit Window\tCtrl+W') 
        fileMenu.Append(exitItem) 
    ...
    class helpPage(wx.Panel):
        def __init__(self, parent, text, screenreader=False):
            ...
            if screenreader == True:
                ...
                # self.acc = MyAcc(textbox)
                # textbox.SetAccessible(self.acc)
