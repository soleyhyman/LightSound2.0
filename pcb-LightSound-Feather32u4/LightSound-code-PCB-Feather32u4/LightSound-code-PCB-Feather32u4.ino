...
/**************************************************************************/
/*********  CODE FOR PCB LIGHTSOUND WITH ADAFRUIT FEATHER 32u4  ***********/
/**************************************************************************/
...
#define VS1053_RX  11 // This is the pin that connects to the RX pin on VS1053
...
SoftwareSerial VS1053_MIDI(NULL, VS1053_RX); //MIDI board; TX only, do not use the 'rx' side
